      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
        ...
        <div className="lg:col-span-2">
          ...
          <div className="flex space-x-4">
            <a href="https://www.instagram.com/projectd_detailing/" target="_blank" rel="noopener noreferrer" className="bg-gray-800 hover:bg-pink-600 p-3 rounded-full transition-colors duration-300">
            ...
            <a href="https://wa.me/541136809256" target="_blank" rel="noopener noreferrer" className="bg-gray-800 hover:bg-green-600 p-3 rounded-full transition-colors duration-300">
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
            ...
            <a
              href="https://www.facebook.com/profile.php?id=100010723411195"
              target="_blank"
        ...
        <div>
          ...
          <ul className="space-y-2">
            ...
            <li className="text-gray-300">
              <span className="text-blue-400">📸</span> @projectd_detailing
            </li>
          </ul>
        </div>
      </div>
